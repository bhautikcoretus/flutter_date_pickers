...
class DatePickerStyles {
  ...
  DatePickerStyles fulfillWithTheme(ThemeData theme) {
    ...
    TextStyle? _yearHeaderStyle =
        yearHeaderStyle ?? theme.accentTextTheme.bodyText1;
    ...
    return DatePickerStyles(
        ...
        nextIcon: nextIcon,
        prevIcon: prevIcon,
        yearHeaderStyle: _yearHeaderStyle);
  }
...
class DatePickerRangeStyles extends DatePickerStyles {
  ...
  final TextStyle? selectedPeriodMiddleTextStyle;
    ...
    final TextStyle? yearTitleTextStyle;
  ...
  DatePickerRangeStyles fulfillWithTheme(ThemeData theme) {
    ...
    final TextStyle? _yearTitleTextStyle =
        yearTitleTextStyle ?? commonStyles.yearTitleTextStyle;
